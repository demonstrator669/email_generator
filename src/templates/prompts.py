...
SYSTEM_PROMPT_TEXT = """# ROLE & PERSONA
...
USER_PROMPT_TEXT = """# TASK: Generate Email Using Russell Brunson Framework
...
EMAIL_GENERATION_PROMPT = PromptTemplate(
    input_variables=[
        "day_number", "email_type", "purpose", "principle", 
        "subject_formula", "structure", "recipient_json", "event_json"
    ],
    template=USER_PROMPT_TEXT
)

# Configuration for Email Types (kept as dict for easy lookup)
EMAIL_TYPES = {
    "0": {
